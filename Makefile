...
#    Updated: 2024/06/11 13:13:04 by lglauch          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
src/utils2.c src/envp.c src/expand.c src/t_lexer.c src/t_file.c src/io_handler.c src/out_handler.c\
src/builtins/check_builtins.c src/builtins/echo.c
